 ...
 */
public class Pacman extends Pilota {
    ...
    public Pacman(float vX, float vY, int radi, float x, float y, int colorR, int colorG, int colorB) {
        super(vX, vY, radi, x, y, colorR, colorG, colorB);
    }
    
    public Pacman(Joc joc, int margeX, int margeY) {
